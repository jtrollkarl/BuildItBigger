 ...
 * on 2016-11-25 at 19:28:53 UTC 
 * Modify at your own risk.
 */

package com.example.jay.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MyEndpoint {
    ...
    /**
     * Create a request for the method "myEndpoint.sayJoke".
     *
     * This request holds the parameters needed by the myApi server.  After setting any optional
     * parameters, call the {@link SayJoke#execute()} method to invoke the remote operation.
     *
     * @return the request
     */
    public SayJoke sayJoke() throws java.io.IOException {
      SayJoke result = new SayJoke();
      initialize(result);
      return result;
    }

    public class SayJoke extends MyApiRequest<com.example.jay.myapplication.backend.myApi.model.MyBean> {

      private static final String REST_PATH = "sayJoke";

      /**
       * Create a request for the method "myEndpoint.sayJoke".
       *
       * This request holds the parameters needed by the the myApi server.  After setting any optional
       * parameters, call the {@link SayJoke#execute()} method to invoke the remote operation. <p>
       * {@link
       * SayJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
       * be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @since 1.13
       */
      protected SayJoke() {
        super(MyApi.this, "POST", REST_PATH, null, com.example.jay.myapplication.backend.myApi.model.MyBean.class);
      }

      @Override
      public SayJoke setAlt(java.lang.String alt) {
        return (SayJoke) super.setAlt(alt);
      }

      @Override
      public SayJoke setFields(java.lang.String fields) {
        return (SayJoke) super.setFields(fields);
      }

      @Override
      public SayJoke setKey(java.lang.String key) {
        return (SayJoke) super.setKey(key);
      }

      @Override
      public SayJoke setOauthToken(java.lang.String oauthToken) {
        return (SayJoke) super.setOauthToken(oauthToken);
      }

      @Override
      public SayJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SayJoke) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SayJoke setQuotaUser(java.lang.String quotaUser) {
        return (SayJoke) super.setQuotaUser(quotaUser);
      }

      @Override
      public SayJoke setUserIp(java.lang.String userIp) {
        return (SayJoke) super.setUserIp(userIp);
      }

      @Override
      public SayJoke set(String parameterName, Object value) {
        return (SayJoke) super.set(parameterName, value);
      }
    }
  ...
  public class SayHi extends MyApiRequest<com.example.jay.myapplication.backend.myApi.model.MyBean> {
